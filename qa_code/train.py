...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument('--vocab_size', type=int, default=7137)
        ...
        self.parser.add_argument('--recon_lambda', type=float, default=0.) 
        self.parser.add_argument('--pf_lambda', type=float, default=0.)
        self.parser.add_argument('--cls_lambda', type=float, default=0.)
        ...
        self.parser.add_argument('--pos_lambda', type=float, default=0.15)           
        ...
        self.parser.add_argument('--max_words_in_sent', type=int, default=25)
        self.parser.add_argument('--vid_max_len', type=int, default=20)
...
if __name__ == '__main__':
    ...
    word_to_id = json.load(open('/mnt/hdd4/leiyu/all_dataset/HGR_T2V/MSVD/annotation/RET/word2int.json', 'rb'))
    id_to_word = json.load(open('/mnt/hdd4/leiyu/all_dataset/HGR_T2V/MSVD/annotation/RET/int2word.json', 'rb'))
    # Create the dataset
    ...
    optim = Adam(model.parameters(), lr=5e-5, betas=(0.9, 0.999))
    ...
    if args.fine_tune is True:
        fname = '/mnt/hdd4/leiyu/workspace/video_re_ma/saved_models/LSTM_1_best.pth'
    ...
    for e in range(start_epoch, start_epoch + 80):
        ...
        logger.write('epoch %d - learning rate, loss: %f' % (e, optim.param_groups[0]['lr']))
