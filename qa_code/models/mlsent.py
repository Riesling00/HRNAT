...
from sentence import SentEncoderConfig, SentAttnEncoder
import torchsnooper

class RoleGraphEncoderConfig(SentEncoderConfig):
  def __init__(self):
    super().__init__()
    self.num_roles = 16
...
class RoleGraphEncoder(SentAttnEncoder):
  def __init__(self, config):
    ...
    # GCN parameters
    self.gcn = GCNEncoder(self.config.rnn_hidden_size, 
